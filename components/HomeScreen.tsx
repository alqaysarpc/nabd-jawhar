...
const featuredNursesData = [
    ...
    { id: 3, name: ' شروق صالح', img: '/3.png', rating: 4.9, specialty: 'رعاية كبار السن', experience: 10, availability: 'offline', languages: ['العربية', 'الإنجليزية'] },
    { id: 4, name: ' سلطان باهبري', img: '/4.png', rating: 4.7, specialty: 'العناية بالجروح', experience: 6, availability: 'available', languages: ['العربية'] },
    { id: 5, name: '  جنى القعيطي', img: '/5.png', rating: 4.6, specialty: 'رعاية اطفال ', experience: 8, availability: 'offline', languages: ['العربية', 'الإنجليزية'] },
