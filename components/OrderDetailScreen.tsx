...
const mockOrderDetails: DetailedOrder[] = [
    { 
        ...
        nurse: { name: 'ماريا باجبير ', img: '/2.png', rating: 4.8, specialty: 'رعاية أمراض مزمنة' },
        date: '2024-07-25',
        time: '10:00 صباحاً',
        status: 'completed',
        patientCount: 1,
    ...
    { 
        ...
        nurse: { name: 'وليد بن قبوس ', img: '/1.png', rating: 4.9, specialty: 'خدمات التمريض العامة' },
        date: '2024-07-28',
        time: '03:30 مساءً',
        status: 'accepted',
        patientCount: 1,
    ...
    { 
        ...
        nurse: { name: 'شروق صالح ', img: '/3.png', rating: 4.7, specialty: 'العناية بالجروح' },
        date: '2024-07-22',
        time: '01:00 ظهراً',
        status: 'completed',
        patientCount: 2,
