...
interface NurseEditAddressScreenProps {
...
const NurseEditAddressScreen: React.FC<NurseEditAddressScreenProps> = ({ address, onBack, onSave }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50">
            ...
            <div className="p-4 bg-white border-t sticky bottom-0">
                <button onClick={handleSave} className="w-full bg-teal-500 text-white py-3 rounded-lg font-bold text-lg shadow-md hover:bg-teal-600 transition">
                    حفظ التغييرات
                </button>
            </div>
        </div>
...
export default NurseEditAddressScreen;